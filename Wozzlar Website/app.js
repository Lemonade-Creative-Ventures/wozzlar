  ...
  if(!_tgInstance){
    _tgInstance = new tourguide.TourGuideClient({
      steps: [
        {
          title: "Let's Play! 🧙‍♂️",
          content: "Solve this phrase word by word. Let's go!",
        },
        {
          target: "#phrase",
          title: "Your Phrase",
          content: "Two mystery words. Click any row to work on it.",
        },
        {
          target: "#kb",
          title: "Make a Guess",
          content: "Try guessing the first word. Type <strong>RODE</strong> then press <strong>ENTER</strong>",
        },
        {
          target: "#phrase",
          title: "Colors Tell the Story",
          content: "<span style='color:#FF4FA3;font-weight:800'>■ Pink</span> = correct spot · <span style='color:#3FCBFF;font-weight:800'>■ Blue</span> = wrong spot · <strong>■ Dark</strong> = not in phrase<br><br>On the left: <em>underlined</em> letters need to move.",
        },
        {
          target: "#kb",
          title: "Keyboard Knows",
          content: "The keyboard shows what you've learned. Notice the key colors?",
        },
        {
          target: "#kb",
          title: "Solve It",
          content: "Now you know where each letter goes. Type <strong>WORD</strong> and press <strong>ENTER</strong>",
        },
        {
          target: "#phrase",
          title: "Next Word! ✨",
          content: "First word solved! Game moved to word 2 automatically.",
        },
        {
          target: "#phrase",
          title: "Keep Going",
          content: "Type <strong>WIZARD</strong> and press <strong>ENTER</strong>",
        },
        {
          target: "#phrase",
          title: "You Did It! 🎉",
          content: "That's the game! <strong>7 guesses daily.</strong> Win → 🏆 Lose → 😐<br><br>Hit <strong>Practice</strong> for unlimited play.",
        },
        {
          title: "Ready! 🚀",
          content: "Now solve today's puzzle!",
        },
      ],
      debug: false,
