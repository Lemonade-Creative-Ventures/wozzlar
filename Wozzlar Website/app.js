  ...
  if(!_tgInstance){
    _tgInstance = new tourguide.TourGuideClient({
      steps: [
        ...
        {
          target: "#phrase",
          title: "Step 1: The Puzzle",
          content: "Here's your mystery phrase. Two words to discover!",
        },
        {
          target: "#phrase",
          title: "Step 2: Select a Word",
          content: "<strong>Try it:</strong> Click the second word row below to select it.",
        },
        {
          target: "#phrase",
          title: "Step 3",
          content: "Good! You can work on any word in any order. Click the first word to continue.",
        },
        {
          target: "#kb",
          title: "Step 4: Type Your Guess",
          content: "<strong>Try it:</strong> Type <strong>WARM</strong> using the keyboard, then press <strong>ENTER</strong>.",
        },
        {
          target: "#phrase",
          title: "Step 5: See the Colors",
          content: "<span style='color:#FF4FA3;font-weight:800'>■ Pink</span> = Right spot!<br><span style='color:#3FCBFF;font-weight:800'>■ Blue</span> = Wrong spot<br><strong>■ Dark</strong> = Not in phrase",
        },
        {
          target: "#phrase",
          title: "Step 6: Check the Tags",
          content: "See your guess on the left? <u>Underlined letters</u> are in the word but wrong position.",
        },
        {
          target: "#kb",
          title: "Step 7: Watch the Keyboard",
          content: "The keyboard shows what you've learned. Notice the colors on the keys you used?",
        },
        {
          target: "#kb",
          title: "Step 8: Try Again",
          content: "<strong>Try it:</strong> Type <strong>WORD</strong> and press <strong>ENTER</strong>.",
        },
        {
          target: "#phrase",
          title: "Step 9: All Pink!",
          content: "Perfect! All letters pink means you solved it. The game auto-moves to the next word.",
        },
        {
          target: "#phrase",
          title: "Step 10: Second Word",
          content: "<strong>Try it:</strong> Type <strong>LIZARD</strong> and press <strong>ENTER</strong>.",
        },
        {
          target: "#phrase",
          title: "Step 11: Almost There",
          content: "See which letters matched? <strong>Try it:</strong> Type <strong>WIZARD</strong> and press <strong>ENTER</strong>.",
        },
        {
          target: "#phrase",
          title: "Step 12: You Did It! ✨",
          content: "You solved the phrase! That's how you play.",
        },
        {
          target: ".nav-left",
          title: "Daily Badges",
          content: "7 guesses per day. Solve it → 🏆 Wozzlar badge. Keep your streak!",
        },
        {
          target: "#btnSolve",
          title: "ALL IN Mode",
          content: "Type the whole phrase at once. High risk, high reward!",
        },
        {
          target: "#btnPractice",
          title: "Practice",
          content: "Play unlimited puzzles here. No pressure!",
        },
        {
          title: "Ready! 🚀",
          content: "You've got this! Go solve today's puzzle.",
        },
      ],
      debug: false,
